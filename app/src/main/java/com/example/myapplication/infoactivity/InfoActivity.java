...
//        usernameTxt.setText(username.toString());
        ...
        btn_reserv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //
                String reservToken = createReservationToken(username,id);
                checkReservationDetails(reservToken);
            }
        });
    ...
    private void checkReservationDetails(String reservToken) {
        Retrofit retrofit = RetrofitInstance.getRetrofit();
        final InterfaceAPI api = retrofit.create(InterfaceAPI.class);

        Call<String> call = api.reservationOrder(reservToken);
